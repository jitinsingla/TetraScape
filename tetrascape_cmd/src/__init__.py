...
class _TetraAPI(BundleAPI):
	...
	def register_command(bi, ci, logger):
	    ...
	    register('tetraChain', t_desc, TetraScape.tetrahedral_model, logger=logger)
	    ...
	    register('tetraMass', m_desc, TetraScape.massing_model, logger=logger)
